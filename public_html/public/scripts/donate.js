document.addEventListener('DOMContentLoaded', function() {
    ...
    if (paypalButton) {
        paypalButton.addEventListener('click', function(e) {
            e.preventDefault();
            window.open('https://paypal.me/joshholmes', '_blank');
        });
    }
    ...
    if (venmoButton) {
        venmoButton.addEventListener('click', function(e) {
            e.preventDefault();
            window.open('https://venmo.com/foreme', '_blank');
        });
    }
...
const DONATION_CONFIG = {
    paypal: {
        button: '#paypalButton',
        url: 'https://paypal.me/joshholmes'
    },
    venmo: {
        button: '#venmoButton',
        url: 'https://venmo.com/foreme'
    },
    cashapp: {
        button: '#cashAppButton',
        url: 'https://cash.app/$scottishinsults'
    }
};
